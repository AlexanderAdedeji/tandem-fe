...
export default function Calendar() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1A1B25] relative pb-[4.5rem] px-4 pt-4 max-w-md mx-auto sm:max-w-full">
      ...
      {/* Optional: Add iOS safe-area inset (if needed) */}
